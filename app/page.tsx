          ...
          <div className="mx-auto w-full max-w-7xl space-y-8">
            ...
            {activeTab === "About" && (
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {/* IMAGE CARD */}
                <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-2 shadow-sm flex items-center justify-center">
                  <Image
                    src="/profile.png"
                    alt="Profile"
                    width={450}
                ...
                <div className="lg:col-span-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-8 shadow-sm">
                  ...
                  <p className="text-zinc-700 dark:text-zinc-300 leading-relaxed">
                    ...
                    <br />
                    I have a recieved my finaly results and have achieved a First-Class Computer Science Degree and have a prior 10 years retail experience.
                    <br />
                  ...
                  <div className="mt-8 space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-zinc-600 dark:text-zinc-400">
                        React • Next.js • CSS/Tailwind • TypeScript • JavaScript • HTML • Flutter
                      </p>
                    </div>
            ...
            {activeTab === "Projects" && (
              <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-8 shadow-sm space-y-6">
                ...
                <p className="text-zinc-700 dark:text-zinc-300">
                  Gamification Dissertation Project
                </p>
